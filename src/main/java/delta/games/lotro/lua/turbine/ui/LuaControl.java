...
public final class LuaControl {
  ...
  public static void add(Lua lua, int envIndex) {
    ...
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "HasFocus", LuaControl::hasFocus);
    ...
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "GetBackColorBlendMode",
        LuaControl::getBackColorBlendMode);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "SetBackColorBlendMode",
        LuaControl::setBackColorBlendMode);
    ...
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "SetStretchMode", LuaControl::setStretchMode);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "IsEnabled", LuaControl::isEnabled);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "SetEnabled", LuaControl::setEnabled);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "IsMouseVisible", LuaControl::isMouseVisible);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "SetMouseVisible",
        LuaControl::setMouseVisible);

    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "GetMousePosition",
        LuaControl::getMousePosition);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "GetAllowDrop", LuaControl::getAllowDrop);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "SetAllowDrop", LuaControl::setAllowDrop);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "GetWantsUpdates",
        LuaControl::getWantsUpdates);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "SetWantsUpdates",
        LuaControl::setWantsUpdates);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "GetWantsKeyEvents",
        LuaControl::getWantsKeyEvents);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "SetWantsKeyEvents",
        LuaControl::setWantsKeyEvents);

    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "IsShiftKeyDown", LuaControl::isShiftKeyDown);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "IsControlKeyDown",
        LuaControl::isControlKeyDown);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "IsAltKeyDown", LuaControl::isAltKeyDown);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "PointToScreen", LuaControl::pointToScreen);
    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "PointToClient", LuaControl::pointToClient);

    LuaTools.setFunction(lua, -1, LuaTools.relativizeIndex(envIndex, -1), "IsDisplayed", LuaControl::isDisplayed);
  ...
  /**
   * @param objectSelf .
   * @return a correspond JComponent.
   */
   ...
   * @param lua   .
   * @param index .
   * @return a correspond content Component.
   */
   ...
   * @param lua   .
   * @param index .
   * @return a correspond content JComponent.
   */
    ...
    if (component != null) {
      switch (key) {
        ...
        case "KeyUp":
          break;
        case "MouseDown": {
          LuaMouseListener mouseListener = LuaMouseListener.luaIndexMetaFunc(lua, component,
        ...
        case "SelectedNodeChanged": {
          ...
          jTree.addTreeSelectionListener(
              new LuaTreeSelectionListener(jTree, LuaObject.findLuaObjectFromObject(component), method));
          break;
        }
      }
    }
  ...
  public static int indexMetaFunc(Lua lua) {
    /*
     * LuaValue self = lua.get(); LuaValue key = lua.get(); JComponent jComponent =
     * LuaControl.findJComponentFromObject(objectSelf);
     * ((LibFunction.TwoArg)jComponent.getClientProperty(LuaControl.
     * jComponentKey_luaEventsFunc)).call(lua1, self1, key);
     * 
  ...
  private static int constructor(Lua lua) {
    ...
    LuaObject.ObjectInheritedConstructor(lua, 1, jPanel.value, _newIndexMetaFunc, null);
    return 0;
  }
   ...
   * @param objectSelf .
   */
  public static void controlInheritedConstructor(Lua lua, int indexSelf, Object objectSelf) {
    ...
    LuaObject.ObjectInheritedConstructor(lua, indexSelf, objectSelf, _newIndexMetaFunc, null);
  }
  ...
  private static int setParent(Lua lua) {
    ...
    if ((component != null) && (!(component instanceof JScrollBar))) {
  ...
  private static int hasFocus(Lua lua) {
    lua.push(true);
    return 1;
  }
  ...
  private static int getBackColor(Lua lua) {
    ...
    if (component != null) {
      LuaTools.invokeAndWait(lua,
          () -> LuaColor.pushLuaColor(lua, Lua51Consts.LUA_ENVIRONINDEX, component.getBackground()));
    }
    return 1;
  }
  ...
  private static int setBackColor(Lua lua) {
    Component component = findContentComponentFromLuaObject(lua, 1);
    if (component != null) {
      Color color = LuaColor.luaColorToColor(lua, 1);
  ...
  private static int setBackColorBlendMode(Lua lua) {
    return 0;
  }
  ...
  private static int setOpacity(Lua lua) {
    /*
     * Component component = findContentComponentFromLuaObject(lua, 1); if
     * (component instanceof JComponent) { double opacity = lua.toNumber(2);
     * SwingUtilities.invokeLater(() -> ((JComponent)component).setOpaque(opacity
     * >.0)); }
     */
    return 0;
  }
  ...
  private static int setStretchMode(Lua lua) {
    return 0;
  }
  ...
  private static int setAllowDrop(Lua lua) {
    return 0;
  }
  ...
  private static int isShiftKeyDown(Lua lua) {
    lua.push(false);
    return 1;
  }

  private static int isControlKeyDown(Lua lua) {
    lua.push(false);
    return 1;
  }

  private static int isAltKeyDown(Lua lua) {
    lua.push(false);
    return 1;
  }

  private static int pointToScreen(Lua lua) {
    lua.push(0);
    lua.push(0);
    return 2;
  }

  private static int pointToClient(Lua lua) {
    lua.push(0);
    lua.push(0);
    return 2;
  }
  ...
  private static int isDisplayed(Lua lua) {
    lua.push(true);
    return 1;
  }
}
