...
--------------------------------------------------------------------------------
local function getindentlevel(source, ast, indenttable)
...
--------------------------------------------------------------------------------
function M.indentcode(source, ast, delimiter,indenttable, ...)
    ...
    local linetodepth = getindentlevel(source, ast, indenttable)
